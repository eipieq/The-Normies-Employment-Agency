...
export function EmploymentCard({
  ...
  return (
    <div className="w-full max-w-4xl grid grid-cols-1 lg:grid-cols-[360px_1fr] gap-4 items-start">
      <div className="w-full max-w-sm lg:max-w-none mx-auto lg:mx-0 lg:sticky lg:top-20 rounded-xl bg-white shadow-[0_1px_4px_rgba(0,0,0,0.06)] p-1 space-y-1">
      ...
      <div className="rounded-xl bg-white shadow-[0_1px_4px_rgba(0,0,0,0.06)] p-4 sm:p-5">
